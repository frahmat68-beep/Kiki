        ...
        <form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-6">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Site Name</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Tagline</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Meta Title</label>
                    ...
                    <div class="sm:col-span-2">
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Meta Description</label>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4">
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Hero Title</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Hero Subtitle</label>
                    ...
                    <div class="sm:max-w-xs">
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Hero CTA Text</label>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Footer Description</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Footer Address</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Footer Email</label>
                        ...
                        <label class="mt-4 text-xs font-semibold text-slate-500 dark:text-slate-300">Footer Phone</label>
                        ...
                        <label class="mt-4 text-xs font-semibold text-slate-500 dark:text-slate-300">Footer Copyright</label>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4">
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Contact Map Embed</label>
                    ...
                    <div class="sm:max-w-sm">
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Form Receiver Email</label>
