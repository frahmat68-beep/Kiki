...
@php
    $rulesKicker = setting('copy.rules_page.kicker', 'Rules Sewa');
    $rulesTitle = setting('copy.rules_page.title', 'Panduan Sewa Manake Rental');
    $rulesSubtitle = setting('copy.rules_page.subtitle', 'Halaman ini merangkum aturan utama supaya proses sewa aman, jelas, dan adil untuk semua user. Aturan ini berlaku untuk booking website, reschedule, dan pengelolaan unit.');
        ...
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            <article class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <ul class="mt-3 space-y-2 text-sm text-slate-600">
                    ...
                    <li><span class="font-semibold text-blue-700">Kode pembayaran berlaku terbatas</span> (umumnya 60 menit) sebelum status berubah expired.</li>
            ...
            <article class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <ul class="mt-3 space-y-2 text-sm text-slate-600">
                    ...
                    <li>Durasi hari sewa harus <span class="font-semibold text-blue-700">tetap sama</span> dengan order awal.</li>
